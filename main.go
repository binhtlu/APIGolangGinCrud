...
func main() {
	...
	router.HandleFunc("/api/v1/user/find", FindUser).Methods("GET")
	router.HandleFunc("/api/v1/user/getall", GetAll).Methods("GET")
	router.HandleFunc("/api/v1/user/create", CreateUser).Methods("POST")
	router.HandleFunc("/api/v1/user/update", UpdateUser).Methods("PUT")
	router.HandleFunc("/api/v1/user/delete", Delete).Methods("DELETE")
